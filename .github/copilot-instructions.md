...
The plugin uses Leaflet.js version 1.9.4 (bundled locally) in combination with OpenStreetMap to display the map and the routes.
...
1. Update the version number in the main plugin file (`art-routes.php`)
