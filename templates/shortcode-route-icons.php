...
@media (max-width: 600px) {
    ...
    .art-route-icon-img, .art-route-icon-fallback {
        max-width: 360px;
        max-height: 360px;
        height: auto;
        line-height: 360px;
...
(function(){
  ...
  items.forEach(function(el, i){ el.classList.remove('center-tile', 'center-tile-mobile-first'); });
  if (items[centerIdx]) {
