...
|--------|-------------|-----------|
| **Art Routes** (Free) | Interactive art route maps with OpenStreetMap integration | [`plugins/wp-art-routes/`](plugins/wp-art-routes/) |
...
```bash
./bin/build-free   # → build/wp-art-routes-X.Y.Z.zip
...
- [Art Routes (Free) README](plugins/wp-art-routes/README.md)
