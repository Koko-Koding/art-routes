 ...
 * Expects wpArtRoutesMultiMapI18n to be localized with: { showAllRoutes, readMore }
 * Per-instance data is passed via wpArtRoutesMultiMapInstances array.
 *
...
var wpArtRoutesMultiMap = (function() {
    'use strict';

    var i18n = (typeof wpArtRoutesMultiMapI18n !== 'undefined') ? wpArtRoutesMultiMapI18n : {};
...
document.addEventListener('DOMContentLoaded', function() {
    if (typeof wpArtRoutesMultiMapInstances !== 'undefined' && Array.isArray(wpArtRoutesMultiMapInstances)) {
        wpArtRoutesMultiMapInstances.forEach(function(instance) {
            wpArtRoutesMultiMap.init(instance.mapId, instance.mapData);
        });
    }
});
