 ...
 * Expects wpArtRoutesEditionMapI18n to be localized with: { viewDetails, readMore }
 * Per-instance data is passed via wpArtRoutesEditionMapInstances array.
 *
 * @package WP Art Routes
 */

var wpArtRoutesEditionMap = (function() {
    'use strict';

    var i18n = (typeof wpArtRoutesEditionMapI18n !== 'undefined') ? wpArtRoutesEditionMapI18n : {};
...
document.addEventListener('DOMContentLoaded', function() {
    if (typeof wpArtRoutesEditionMapInstances !== 'undefined' && Array.isArray(wpArtRoutesEditionMapInstances)) {
        wpArtRoutesEditionMapInstances.forEach(function(instance) {
            wpArtRoutesEditionMap.init(instance.mapId, instance.mapData, instance.options || {});
        });
    }
});
