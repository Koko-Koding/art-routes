 ...
 * Expects wpArtRoutesCustomIcons to be localized with: { deleteNonce, i18n }
 *
 * @package WP Art Routes
 */

jQuery(document).ready(function($) {
    if (typeof wpArtRoutesCustomIcons === 'undefined') {
        return;
    }

    var i18n = wpArtRoutesCustomIcons.i18n;
    ...
    $(document).on('click', '.delete-custom-icon', function() {
        ...
        $.ajax({
            ...
            data: {
                ...
                filename: filename,
                nonce: wpArtRoutesCustomIcons.deleteNonce
            },
            success: function(response) {
                if (response.success) {
