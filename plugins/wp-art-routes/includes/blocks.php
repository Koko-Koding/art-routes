<?php
/**
 * Gutenberg Blocks Registration for WP Art Routes Plugin
 *
...
function wp_art_routes_register_blocks()
{
    ...
    wp_register_style(
        'wp-art-routes-edition-map-block-editor',
        WP_ART_ROUTES_PLUGIN_URL . 'assets/css/blocks/edition-map-block-editor.css',
        ['wp-edit-blocks'],
        WP_ART_ROUTES_VERSION
    );
    ...
    register_block_type('wp-art-routes/edition-map', [
        ...
        'editor_style' => 'wp-art-routes-edition-map-block-editor',
...
function wp_art_routes_render_edition_map_block($attributes)
{
    ...
    return wp_art_routes_edition_map_shortcode($shortcode_atts);
}
 ...
 */
function wp_art_routes_block_categories($categories)
{
    return array_merge(
        $categories,
        [
...
add_filter('block_categories_all', 'wp_art_routes_block_categories', 10, 1);
