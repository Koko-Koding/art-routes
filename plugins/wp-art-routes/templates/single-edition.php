    ...
    ?>
        <article id="post-<?php the_ID(); ?>" <?php post_class('edition-single'); ?>>
            ...
            ?>
                ...
                wp_enqueue_script('wp-art-routes-edition-map-js');

                // Pass per-instance data via inline script
                wp_add_inline_script('wp-art-routes-edition-map-js',
                    'var wpArtRoutesEditionMapInstances = wpArtRoutesEditionMapInstances || [];' .
                    'wpArtRoutesEditionMapInstances.push(' . wp_json_encode([
                        'mapId'   => $map_id,
                        'mapData' => $js_data,
