...
<div class="art-routes-single-artwork">
        ...
        <article id="post-<?php the_ID(); ?>" <?php post_class('artwork-single'); ?>>
            ...
            ?>
                <div class="artwork-location-map">
                    ...
                    wp_enqueue_script('art-routes-single-artwork-map-js');

                    // Pass artwork data to the map script
                    $icon_url = art_routes_get_location_icon_url(get_the_ID());
                    wp_localize_script('art-routes-single-artwork-map-js', 'artRoutesSingleArtwork', [
