...
if (empty($route)) {
    echo '<p class="art-routes-error">' . esc_html__('Route not found.', 'art-routes') . '</p>';
    return;
}
...
<div class="art-route-container">
    ...
    <div class="art-route-details">
        ...
        <div class="route-actions">
            <a href="<?php echo esc_url(wp_nonce_url(admin_url('admin-ajax.php?action=art_routes_export_gpx&route_id=' . $route['id']), 'art_routes_export_gpx')); ?>" 
